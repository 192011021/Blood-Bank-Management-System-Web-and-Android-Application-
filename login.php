...
<body background="image\blood-cells.jpg">
  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      ...
      <div class="card" style="height:300px; background-rgba(255, 255, 255, 0.3);margin-left:250px;margin-right:250px">
          <div class="card-body" >
  ...
  <a href="signup.php" >Do not have an Account! Signup</a>
  </div>
    </div>
  </div></div>
<br>
  ...
  if(isset($_POST["login"])){
    ...
    $sql="SELECT * from user_info where donor_username='$username' and donor_password='$password'";
